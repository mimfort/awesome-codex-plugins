...
Ask the user to confirm or provide a different version.
...
Ask the user whether to update these version strings — options: yes to all, choose individually, or skip.
