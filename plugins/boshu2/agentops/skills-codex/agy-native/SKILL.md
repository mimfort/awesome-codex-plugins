...
- [`$dual-pane-atm`](../dual-pane-atm/SKILL.md) — **in-ATM AGY** (interactive pane-3 TUI via `atm send`) vs this skill's **headless** `agy --print` / sidecar paths; do not conflate them.
