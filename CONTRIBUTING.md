...
```bash
pipx install --force "plugin-scanner==2.0.859"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `6e6e610a041e3fc397cba6d2f068da7402a50f903c16a251dc6d5cc9938de13d`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.859"
