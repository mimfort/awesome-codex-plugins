...
```bash
pipx install --force "plugin-scanner==2.0.860"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `f3b88d4432c27be4168626d7e562a05a450bb080534abaa4064656d26dd38dcc`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.860"
