...
```bash
pipx install --force "plugin-scanner==2.0.912"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `3d61753e9e5a759663cc02ba66e9acc4dc88c762fa547cbe3b3d95e938a89b71`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==2.0.912"
